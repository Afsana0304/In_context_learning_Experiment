...
ds_train =  pd.read_csv("/hpi/fs00/home/afsana.mimi/llama_project/synthetic_data/data2.csv")
articles_train = ds_train['article']
highlights_train = ds_train['summary'] 
...
plots_dir = os.path.join(script_dir, 'exp3_deepseek_data') #chnage the name
os.makedirs(plots_dir, exist_ok=True)

#creating the csv file
csv_file_path = os.path.join(script_dir, 'generated_summaries_exp3.csv') #chnage the name
